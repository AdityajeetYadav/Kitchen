...
public class SoundManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        BaseCounterClass.OnAnyObjectPlacedHere += BaseCounter_OnAnyObjectPlacedHere;
    ...
    {
        BaseCounterClass baseCounterClass = sender as BaseCounterClass;
        PlaySound(audioClipsRefsSO.objectDrop, baseCounterClass.transform.position);
    }
